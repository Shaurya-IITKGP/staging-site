...
export default function MainPage() {
  ...
  return (
    ...
    <div className="min-h-screen relative bg-cover bg-center flex flex-col overflow-hidden">
      {/* Background Image */}
      <div className="absolute inset-0 bg-gradient-to-r from-gray-900 to-black opacity-80 h-full"
      style={{ backgroundImage: `url(/mainPage2.jpg)` }}></div>
      <div className="fixed inset-0  bg-cover opacity-30"></div>
